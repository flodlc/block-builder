...
export const MentionDecoration = ({
    ...
    return (
        ...
        >
            <span data-ignore={true} style={{ verticalAlign: 'middle' }}>
                <svg
                    viewBox="0 0 17 17"
                    style={{
                        width: '1em',
            ...
            <span style={{ opacity: 0 }}>{mark.d?.triggeringExpression}</span>
            {!searchText ? <span className="mention_placeholder" /> : <></>}
